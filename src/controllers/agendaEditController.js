...
module.exports = {
  async index(req, res){
    ...
    let { animalValue, dataEdit, horaEdit, servicoEdit } = req.body;
    ...
    if(agendaAlreadyExists){
      ...
      newSchedule = await Schedule.updateOne({ _id: agenda_id }, { animal: animalValue, data: dataEdit, hora: horaEdit, servico: servicoEdit });
